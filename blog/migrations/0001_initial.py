    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="month",
                        help_text="The default look of the calendar on this page.",
                        max_length=255,
                        verbose_name="Calendar Style",
                    ),
                ),
                (
                    "event_style",
                    models.CharField(
                        ...
                        choices=[
                            ("", "Default"),
                            ("block", "Solid rectangles"),
                            ("list-item", "Dots with labels"),
                        ],
                        default="",
                        help_text="How events look on the calendar.",
                        max_length=255,
                        verbose_name="Event Style",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "calendar_color",
                    coderedcms.fields.ColorField(
                        blank=True,
                        help_text="The color that the event will use when displayed on a calendar.",
                        max_length=255,
                    ),
                ),
            ...
            bases=(
                "coderedcms.coderedpage",
                models.Model,
                eventtools.models.OccurrenceMixin,
            ),
        ),
        migrations.CreateModel(
            name="Footer",
            ...
            fields=[
                ...
                (
                    ...
                    models.FloatField(
                        blank=True,
                        default=0,
                        help_text="The default latitude you want the map set to.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.FloatField(
                        blank=True,
                        default=0,
                        help_text="The default longitude you want the map set to.",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="If checked, automatically update the latitude and longitude when the address is updated.",
                        verbose_name="Auto Update Latitude and Longitude",
                    ),
                ),
                (
                    "map_title",
                    models.CharField(
                        blank=True,
                        help_text="If this is filled out, this is the title that will be used on the map.",
                        max_length=255,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="If this is filled out, this is the description that will be used on the map.",
                        max_length=255,
                        verbose_name="Map Description",
                    ),
                ),
                (
                    "safebear_cms",
                    models.TextField(blank=True, verbose_name="safebear_cms"),
                ),
                (
                    "phone_number",
                    models.CharField(
                            ...
                            5: (
                                ...
                                [
                                    [
                                        ...
                                        ("custom_css_class", 1),
                                        ("custom_id", 2),
                                        ("ga_tracking_event_category", 3),
                                        ("ga_tracking_event_label", 4),
                                    ]
                                ],
                                {},
                            ),
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, db_index=True, null=True, verbose_name="end"
                    ),
                ),
                (
                    "repeat",
                    eventtools.models.ChoiceTextField(
                        blank=True,
                        choices=[
                ...
                (
                    "repeat_until",
                    models.DateField(
                        blank=True, null=True, verbose_name="repeat_until"
                    ),
                ),
                (
                    "event",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Optional - email form submissions to this address. Separate multiple addresses by comma.",
                        max_length=255,
                        verbose_name="Email form submissions to",
                    ),
                ),
                (
                    "reply_address",
                    models.CharField(
                        blank=True,
                        help_text='Optional - to reply to the submitter, specify the email field here. For example, if a form field above is labeled "Your Email", enter: {{ your_email }}',
                        max_length=255,
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Submissions are saved to database and can be exported at any time.",
                        verbose_name="Save form submissions",
                    ),
                ),
                (
                    "button_text",
                    models.CharField(
                        default="Submit", max_length=255, verbose_name="Button text"
                    ),
                ),
                (
                    "button_style",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Custom CSS class applied to the submit button.",
                        max_length=255,
                        verbose_name="Button CSS class",
                    ),
                ),
                (
                    "form_css_class",
                    models.CharField(
                        blank=True,
                        help_text="Custom CSS class applied to <form> element.",
                        max_length=255,
                        verbose_name="Form CSS Class",
                    ),
                ),
                (
                    "form_id",
                    models.CharField(
                        blank=True,
                        help_text="Custom ID applied to <form> element.",
                        max_length=255,
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Date and time when the FORM goes live on the page.",
                        null=True,
                        verbose_name="Form go live date/time",
                    ),
                ),
                (
                    "form_expire_at",
                    models.DateTimeField(
                        blank=True,
                        help_text="Date and time when the FORM will no longer be available on the page.",
                        null=True,
                        verbose_name="Form expiry date/time",
                    ),
                ),
                (
                    "spam_protection",
                    models.BooleanField(
                        default=True,
                        help_text="When enabled, the CMS will filter out spam form submissions for this page.",
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="The page users are redirected to after submitting the form.",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="+",
                        to="wagtailcore.page",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text='For example: "sender@example.com" or "Sender Name <sender@example.com>" (without quotes).',
                        max_length=255,
